    ...
    const FilterContent = (
        <div className="space-y-1 h-full">
            <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="sticky top-0 bg-white z-20 pb-4 pt-2"
            >
                ...
                {isMobileOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed right-0 top-0 bottom-0 w-full sm:w-[400px] bg-white z-50 lg:hidden shadow-2xl flex flex-col"
                        >
