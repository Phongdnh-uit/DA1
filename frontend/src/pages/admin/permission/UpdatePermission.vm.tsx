...
import type { PermissionRequestDTO, PermissionResponseDTO } from "@/types";
...
export default function useUpdatePermissionVM(data?: PermissionResponseDTO) {
  ...
  const onSubmit = (request: PermissionRequestDTO) => {
