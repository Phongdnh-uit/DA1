...
const ThreadSuggestions: FC = () => {
    return (
        <div className="aui-thread-welcome-suggestions grid w-full gap-2 pb-4 @md:grid-cols-2">
            {[
                {
                    title: "Tìm căn hộ chung cư",
                    label: "giá khoảng 2-3 tỷ",
                    action: "Tìm căn hộ chung cư giá khoảng 2-3 tỷ",
                },
                {
                    title: "Tôi muốn thuê nhà nguyên căn",
                    label: "tại khu vực Quận 7",
                    action: "Tôi muốn thuê nhà nguyên căn tại khu vực Quận 7",
                },
                {
                    title: "Tìm mặt bằng kinh doanh",
                    label: "ở mặt tiền đường lớn",
                    action: "Tìm mặt bằng kinh doanh ở mặt tiền đường lớn",
                },
                {
                    title: "Tìm nhà đất",
                    label: "diện tích trên 100m2",
                    action: "Tìm nhà đất diện tích trên 100m2",
                },
                {
                    title: "Tìm căn hộ 2 phòng ngủ",
                    label: "cho thuê",
                    action: "Tìm căn hộ 2 phòng ngủ cho thuê",
                },
            ...
            <ThreadPrimitive.If running={false}>
                <ComposerPrimitive.Send asChild>
                    <TooltipIconButton
                        ...
                        variant="default"
                        size="icon"
                        className="aui-composer-send size-[34px] rounded-full p-1 bg-blue-700 hover:bg-blue-400"
            ...
            <ThreadPrimitive.If running>
                <ComposerPrimitive.Cancel asChild>
                    <Button
                        ...
                        variant="default"
                        size="icon"
                        className="aui-composer-cancel size-[34px] rounded-full border border-muted-foreground/60 dark:border-muted-foreground/90 bg-blue-500 hover:bg-blue-400"
